...
class LanguageDataTest {
    ...
    @Test
    @DisplayName("testGetReconnectMessageEnglishOutput")
    void testGetReconnectMessageEnglishOutput() {
        LanguageData data = new LanguageData();

        assertEquals("Reconnection will begin after 30 seconds.", data.getReconnectMessage(30));
    }

    @Test
    @DisplayName("testGetReconnectMessageChineseOutput")
    void testGetReconnectMessageChineseOutput() {
        LanguageData data = LanguageData.getChineseLanguage();

        assertEquals("15 秒后将开始重新连接。", data.getReconnectMessage(15));
    }
    ...
    @Test
    @DisplayName("testGetReconnectMessageDifferentSeconds")
    void testGetReconnectMessageDifferentSeconds() {
        LanguageData data = new LanguageData();

        assertTrue(data.getReconnectMessage(1).contains("1 seconds"));
        assertTrue(data.getReconnectMessage(100).contains("100 seconds"));
    }
}
