...
public final class ClientConsole {
    ...
    public static void initializeLogger(boolean noColor) {
        ...
        RuntimeState.setLoggist(new Loggist(logFile));
        if (noColor) {
            RuntimeState.loggist().disableColor();
        }
        RuntimeState.loggist().openWriteChannel();
    }
    ...
    public static void requestAccessKeyIfMissing() {
        ...
        if (ConnectionState.snapshot().key() == null) {
            ...
            ConnectionState.setKey(RuntimeState.inputScanner().nextLine());
        }
    }
    ...
    public static void requestLocalPortIfMissing() {
        ...
        if (ConnectionState.snapshot().localPort() == NeoLink.INVALID_LOCAL_PORT) {
            ...
            String input = RuntimeState.inputScanner().nextLine();
            try {
    ...
    public static void exitAndFreeze(int exitCode) {
        ...
        RuntimeState.inputScanner().nextLine();
    ...
    public static void sayInfoNoNewLine(String str) {
        if (RuntimeState.loggist() != null) {
            RuntimeState.loggist().sayNoNewLine(new State(LogType.INFO, "HOST-CLIENT", str));
        } else {
    ...
    public static void say(String str) {
        if (RuntimeState.loggist() != null) {
            RuntimeState.loggist().say(new State(LogType.INFO, "HOST-CLIENT", str));
        } else {
    ...
    public static void say(String str, LogType logType) {
        if (RuntimeState.loggist() != null) {
            RuntimeState.loggist().say(new State(logType, "HOST-CLIENT", str));
        } else {
            System.out.println("[LOG-PENDING] " + str);
        }
    }
